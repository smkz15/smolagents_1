...
3) install smolagents'library : "pip install smolagents litellm duckduckgo-search ollama"
...
5) in the file model1.py ou put the code if you do not downoald the file.
